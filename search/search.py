...
def uniformCostSearch(problem):
    ...
    return search(problem, util.PriorityQueueWithFunction(_cost)) # TODO fijarse q estan al reves los costos
...
def aStarSearch(problem, heuristic=nullHeuristic):
    ...
    def _costWithHeuristic(item):
        (nextState, action) = item
        return problem.getCostOfActions(action) + heuristic(nextState, problem)

    return search(problem, util.PriorityQueueWithFunction(_costWithHeuristic))
